...
[`procedural-planets`](../procedural_planets/GUIDE.md) demonstrates the shared-field form: one
...
[`water-optics`](../water_optics/GUIDE.md) applies the same contract: `resolvedNormalAndCrest()`
...
The `structured-ash-growth` example under [`procedural-vegetation`](../procedural_vegetation/GUIDE.md)

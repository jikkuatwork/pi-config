...
Read [references/grammar-and-mesh-compiler.md](01_grammar_and_mesh_compiler.md) before implementing the generator.
...
Use [`procedural-geometry`](../procedural_geometry/GUIDE.md) for a reusable profile, sweep, ring, or mesh
writer without a building grammar. This module owns massing, façade semantics,

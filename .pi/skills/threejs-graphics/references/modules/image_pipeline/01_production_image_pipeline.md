...
[`procedural-geometry`](../procedural_geometry/GUIDE.md) — owns three composers:
...
- The frost blur must guard its weight normalization and scale pointer decay
  by delta time; the [`temporal-surfaces`](../temporal_surfaces/GUIDE.md) frost example does both.

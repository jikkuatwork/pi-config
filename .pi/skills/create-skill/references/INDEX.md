...
Use a tiny front door by default: `SKILL.md` contains frontmatter only, and detailed instructions live behind `metadata.references.index`.

### Local frontmatter-only template
...
## Route
- `01_core.md` — read for normal use.
- `99_eval_prompts.md` — read when editing triggers or validating behavior.
```

## Step 3 — Keep context clean

- Put only `name`, `description`, and routing metadata in `SKILL.md` by default.
- Move all workflow, examples, provenance, and eval material to `references/*.md`.

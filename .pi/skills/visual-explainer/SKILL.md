...
metadata:
  ...
  upstream-commit: 8f1d0e38ab0f265632a31d2fd032f7b730c98c15
---
...
**Local import safety override.** This repo vendors reviewed skills manually. Deployment/sharing helpers are intentionally not vendored. Do not invoke optional network/image-generation tools such as `surf` without explicit user permission. Normal local HTML generation is fine.

...
Apply `01_privacy.md` throughout delivery. Keep specifications, HTML, receipts,
screenshots, diagnostics, and hashes on local paths; do not upload or pass them
to a remote viewer, validator, or sharing service.
...
The zero-dependency command uses a locally installed Chrome/Chromium through
the DevTools pipe with background networking disabled. It measures light-theme
containment at 1440×900, 1600×1000, 1920×1080, and 2048×1320, then captures
light/dark screenshots at 1440×900 and 2048×1320. It
...
The delivered page may load the owner-approved fixed Google Fonts resources.
Its global and link-level no-referrer policy prevents the artifact URL and
repository-derived data from accompanying those requests. Do not automatically
open any embedded repository-evidence link.

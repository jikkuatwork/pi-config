...
- Very light weights are usually display treatments. As a conservative starting point, use `400`+ below roughly `18px` and reserve `100`–`300` for larger text; verify the actual face, platform rendering, contrast, and target displays rather than treating those cutoffs as universal.

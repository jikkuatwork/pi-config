...
When generating palettes for multiple hues, shared **lightness** and **chroma percentage** can provide a coherent starting grid. They improve consistency relative to HSL or one absolute chroma, but do not guarantee equal perceived brightness or vividness; inspect and tune the rendered colors in context.

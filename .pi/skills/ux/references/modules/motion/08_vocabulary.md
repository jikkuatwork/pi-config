...
- **Compositor-friendly motion** — Properties such as transform and opacity are common candidates for compositing without layout; actual smoothness depends on browser, effects, area, and main-thread/GPU load.

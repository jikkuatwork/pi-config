...
- Numbers in tables right-align to the trailing edge (see the typography module for tabular figures); text left-aligns to the leading edge.
...
- One primary action per view (see the colors module for how color enforces this).

...
> Adapted from LottieFiles' motion-design skill at commit `f9a8a041`. Read
> `02_review.md` first: the numeric recipes and “always/never” language below
> are design hypotheses, not accessibility standards or universal laws.
